...
function HeroSection() {
  return (
    <div
      className="h-auto md:h-[47rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden
   ...
   <Spotlight
      ...
      <div className="p-4 relative z-10 w-full text-center">
        ...
        className="bg-white dark:bg-black text-black dark:text-white border-neutral-200 dark:border-slate-800 relative "
      >
        Explore courses
      </Button>
            </Link>
